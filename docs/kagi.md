...
> **Repo-Note:** Wird vom OpenClaw-Agent für Web-Search via curl genutzt.
> Korrekte Verwendung: `POST https://kagi.com/api/v1/search` + `Authorization: Bearer <key>` + JSON-Body `{"query": "..."}`.
